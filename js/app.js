(function () {
  ...
  const i18n = {
    fr: {
      "nav.home": "Accueil", "nav.program": "Programme", "nav.dress": "Code Couleurs", "nav.story": "Galerie", "nav.rsvp": "RSVP", "nav.souvenir": "Cadre Souvenir", "nav.dashboard": "Admin",
      ...
      "dress.eyebrow": "Pour cette journée",
      "dress.title": "Code Couleurs",
      "dress.intro": "Nous serions honorés que vous vous joigniez à l'harmonie de nos couleurs pour cette journée.",
      "dress.rose": "Rose Poudré",
      "dress.white": "Blanc",
      "dress.gold": "Or",
      "dress.note": "Toute nuance de rose poudré, blanc ou doré sera la bienvenue dans votre tenue.",
    ...
    en: {
      "nav.home": "Home", "nav.program": "Schedule", "nav.dress": "Dress Code", "nav.story": "Gallery", "nav.rsvp": "RSVP", "nav.souvenir": "Photo Frame", "nav.dashboard": "Admin",
      ...
      "punct.sign": "— Lucie & Grégroires",
      "dress.eyebrow": "For this special day",
      "dress.title": "Color Palette",
      "dress.intro": "We would be honored if you joined the harmony of our colors for this celebration.",
      "dress.rose": "Blush Pink",
      "dress.white": "White",
      "dress.gold": "Gold",
      "dress.note": "Any shade of blush pink, white, or gold is welcome in your outfit.",
